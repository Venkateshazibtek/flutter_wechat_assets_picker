...
class DefaultAssetPickerBuilderDelegate extends AssetPickerBuilderDelegate<AssetEntity, AssetPathEntity> {
  ...
  Widget imageAndVideoItemBuilder(
    ...
    String result = titleOfImage(imageProvider);
    return Stack(
      children: <Widget>[
        Positioned.fill(
          child: RepaintBoundary(
        ...
        if (uploadedIds != null && uploadedIds!.contains(asset.id) || uploadedIds!.contains(result))
          Container(
      ...
      builder: (BuildContext context, String descriptions, __) {
        ...
        final Widget innerSelector = AnimatedContainer(
          ...
          decoration: BoxDecoration(
            border: !selected
                ? Border.all(
                    color: uploadedIds!.contains(asset.id) || uploadedIds!.contains(result) ? Color(0xff5d5d5d) : context.theme.unselectedWidgetColor,
                ...
                child: Row(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Icon(Icons.videocam, size: 16, color: uploadedIds!.contains(asset.id) || uploadedIds!.contains(result) ? Color(0xff5d5d5d) : Colors.white),
                    ),
                    Expanded(
                      child: ScaleText(
                        textDelegate.durationIndicatorBuilder(
                        ...
                        style: TextStyle(color: uploadedIds!.contains(asset.id) || uploadedIds!.contains(result) ? Color(0xff5d5d5d) : Colors.white, fontSize: 11),
    ...
    return Platform.isAndroid
        ? Positioned(
            ...
            child: Text(
              ...
              style: TextStyle(color: uploadedIds!.contains(asset.id) || uploadedIds!.contains(result) ? Color(0xff5d5d5d) : Colors.white, fontSize: 13),
            ),
          )
        : Positioned(
            bottom: 0,
